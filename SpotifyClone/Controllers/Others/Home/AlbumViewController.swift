...
class AlbumViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        fetchData()
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Kaydet", style: .done, target: self, action: #selector(didTapSave))
    }
...
extension AlbumViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let headerViewModel = AlbumDetailsHeaderViewModel(
            ...
            releaseDate: "Çıkış Tarihi: \(String.formattedDate(string: album.release_date))",
