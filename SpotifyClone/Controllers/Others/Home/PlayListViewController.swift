...
class PlayListViewController: UIViewController {
    ...
    @objc private func didLongPress(_ gesture: UIGestureRecognizer) {
        ...
        let actionSheet = UIAlertController(title: trackToDelete.name, message: "Bu çalma listesini kaldırmak istediğine emin misin?", preferredStyle: .actionSheet)
        present(actionSheet, animated: true)
        actionSheet.addAction(UIAlertAction(title: "Vazgeç", style: .cancel))
        actionSheet.addAction(UIAlertAction(title: "Kaldır", style: .destructive, handler: {[weak self] _ in
