...
//        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "cell")
    ...
    func update(with results: [SearchResult]) {
        ...
        self.sections = [
            SearchSection(title: "Şarkılar", results: tracks),
            SearchSection(title: "Sanatçılar", results: artists),
            SearchSection(title: "Albümler", results: albums),
            SearchSection(title: "Çalma Listeleri", results: playlists)
        ]
