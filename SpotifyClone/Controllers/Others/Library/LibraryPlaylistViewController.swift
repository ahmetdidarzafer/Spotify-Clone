...
class LibraryPlaylistViewController: UIViewController {
    ...
    private func setNoPlaylistView() {
        ...
        noPlaylistsView.configure(with: ActionLabelViewViewModel(text: "Çalma Listen Yok.", actionTitle: "Oluştur"))
    ...
    func showCreatePlaylistAlert() {
        let alert = UIAlertController(title: "Yeni Çalma Listesi", message: "Çalma Listesinin İsmini Girin", preferredStyle: .alert)
            ...
            APIManager.shared.createPlaylist(with: text) { [weak self] success in
                DispatchQueue.main.async {
                    if success {
                        ...
                        print("Çalma listesi oluşturulamadı.")
                    }
                }
